                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(//border: Border.all(color: Color(0xff4c5463)),
                                  ...
                                  image: DecorationImage(image: AssetImage(Home_pics[index]),fit: BoxFit.fill)
                              ),
                              //child: Text(Home_names[index],style: TextStyle(color: Colors.white),),
                            ),
                            Page_content(Home_names[index], 15, FontWeight.bold, maingreen)
                          ],
                        ),
                      );
                    },
                    ...
                    children: [
                      SizedBox( width: width/1.8,
                        child: Padding(
                          ...
                          child: Page_content("Get listed on our website and access membership "
                  "benefits by registering your homes.", 13, FontWeight.bold, black),
                        ),
                      ),
                      Consumer<LoginProvider>(
                          ...
                          return MaterialButton(
                            ...
                            child: Padding(
                              ...
                              child: Page_content("Join Us", 18, FontWeight.bold, Colors.white),
                            ),
                          );
                        }
                      ),
