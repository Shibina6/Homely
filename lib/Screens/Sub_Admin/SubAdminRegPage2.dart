                          ...
                          child: SizedBox(
                                    ...
                                    child: Container(
                                      ...
                                      child: InkWell(
                                        onTap: (){Image_alert(context,index);},
                                          child: Image.file(value.HomeImage_List[index], fit: BoxFit.fill,)),
                                    ),
                                  );
                                }
                            ) :
                            ...
                            ListView.builder(
                              //physics:  NeverScrollableScrollPhysics(),
                                scrollDirection: Axis.horizontal,
                                shrinkWrap: true,
                                itemCount: value.image_list.length,
                                itemBuilder: (BuildContext context, int index)
                                {
                                  ...
                                  return Card(
                                    child: InkWell(
                                        onTap: (){Image_alert(context,index);},
                                        child: Image.network(value.image_list[index], fit:  BoxFit.fill,)),
                                  );
                                }
                            ):null,
                          ),
